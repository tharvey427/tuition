...
insert into employee values(1, 'Hermoine', 'Granger', 'her', 'grange');
insert into employee values(2, 'Luna', 'Lovegood', 'loony', 'love');
insert into employee values(3, 'Dobby', 'Free Elf', 'dobby', 'socks', 1);
insert into employee values(4, 'Nymphadora', 'Tonks', 'tonks', 'lupin', 2);
insert into employee values(5, 'Rowena', 'Ravenclaw', 'raven', 'claw', 4);
insert into employee values(6, 'Sybill', 'Trelawney', 'syb', 'lawn', 4);
insert into employee values(7, 'Filius', 'Flitwick', 'flit', 'wick', 2);
...
insert into emp_role values(1, 1, 4);
insert into emp_role values(2, 1, 3);
insert into emp_role values(3, 1, 1);
insert into emp_role values(4, 2, 3);
insert into emp_role values(5, 2, 1);
insert into emp_role values(3, 3, 1);
insert into emp_role values(4, 4, 2);
insert into emp_role values(5, 5, 1);
insert into emp_role values(6, 6, 1);
